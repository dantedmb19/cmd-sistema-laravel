...
@if (Session::has("ok-borrar"))

<script>
  notie.alert({ type: 3, text: '¡No se logro eliminar dicho administrador', time: 10 })
</script>
@endif
...
<script>
  notie.alert({ type: 1, text: '¡Se logro eliminar el administrador', time: 10 })
</script>
@endif
