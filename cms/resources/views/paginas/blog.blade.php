...
@if (Session::has("no-validacion-imagen-logo"))
...
@if (Session::has("no-validacion-imagen-portada"))
...
<script>
   ...
   notie.alert({
    ...
    type: 2,
    text: 'La portada no tiene el formato correcto!',
    time: 7
...
@if (Session::has("no-validacion-imagen-icono"))
...
<script>
   ...
   notie.alert({
    ...
    type: 2,
    text: 'El icono no tiene el formato correcto!',
    time: 7
