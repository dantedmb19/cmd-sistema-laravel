...
class BlogController extends Controller
{
    ...
    public function Update($id,Request $request){
        ...
        if(!empty($datos)){
        	...
        	//Verificacion de entredas de imagen
        	if($logo["logo_temporal"] !=""){
        		...
        		if($validarLogo->fails()){
        			...
        			return redirect("/")->with("no-validacion-imagen-logo", "");
        		}
        	}

        	//Verificacion de entredas de portada
        	if($portada["portada_temporal"] !=""){
        		...
        		if($validarPortada->fails()){
        			...
        			return redirect("/")->with("no-validacion-imagen-portada", "");
        		}
        	}

        	//Verificacion de entredas de icono
        	if($icono["icono_temporal"] !=""){
        		...
        		if($validarIcono->fails()){
        			...
        			return redirect("/")->with("no-validacion-imagen-icono", "");
        		}
        	}
        	...
        	if($validar->fails()){
        		...
        		return redirect("/")->with("no-validacion","");
        		  ...
        		  //subir imagenes al servidor la imagen loco
        	      ...
        	      //subir imagenes al servidor la imagen portada
        	      ...
        	      //subir imagenes al servidor la imagen icono
        	      if($icono["icono_temporal"] != ""){
                    ...
                    if($icono["portada_temporal"]->guessExtension() == "jpeg"){
    ...
    /*=====  End of Metodo Update de Laravel  ======*/
